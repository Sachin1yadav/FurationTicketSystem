...
const AllTickets = () => {
  ...
  useEffect(() => {
    ...
    const acBuses = data.filter((item) => item.ac === true);
    const nonAcBuses = data.filter((item) => item.ac === false);
    setAcBuses(acBuses)
  ...
  return (
    <div className="AllTicketsMainDiv">
      ...
      <div className="BusDiv">
        {data.map((item) => (
          <div className="MainDetailsDiv" key={item.id}>
            <h1>
              {" "}
            ...
            {/* Render other properties of the fetched data */}
            <div className="BudBookingDiv">
              <Link to={`/bus/${item.id}`}>
                <Button colorScheme="red">BOOK Now</Button>
              </Link>

              <Button onClick={() => showModal(item.id)} colorScheme="whatsapp">
                Details
              </Button>
            </div>
          </div>
        ...
        <ModalContent>
          ...
          <div className="MainDetailsDivModal">
            ...
            <div id="BusNumberDiv">
              ...
              <button> {singledata && singledata.ac ? "AC" : "Non-AC"} </button>
            </div>
